...
/// <summary>Les villes et structures d'un hexagone (nom de carte API, ex. « DeadLandsHex »).</summary>
public sealed record WarMapHexDto(string Map, List<WarMapTownDto> Towns, List<WarMapStructDto> Structures);
