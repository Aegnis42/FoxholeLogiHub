...
public static class RegimentEndpoints
{
    ...
    public static void MapRegimentEndpoints(this WebApplication app)
    {
        ...
        app.MapPost("/api/regiments", async (CreateRegimentRequest req, ClaimsPrincipal p, AppDbContext db, ConnectionTracker tracker) =>
        {
            ...
            var officier = new RegimentRole { RegimentId = reg.Id, Name = "Officier", Permissions = (int)(RegimentPermission.ManageMembers | RegimentPermission.Invite | RegimentPermission.ManageAlliances | RegimentPermission.ResupplyShare | RegimentPermission.ResupplyManage) };
